...
<style>
.ccm-ui .ccm-block-svg_social_media_icons {
    text-align: left;
}
...
.ccm-block-svg_social_media_icons .ui-sortable-helper {
...
<div class="ccm-tab-content ccm-block-svg_social_media_icons" id="ccm-tab-content-colorstyle" style="position: relative; height: 475px;">
    ...
    <div class="form-group">
        ...
        <?php echo $form->select('position', array('left' => t('left'), 'center' => t('center'), 'right' => t('right')), $position, array('style' => 'width: 95px;')); ?>
    </div>
